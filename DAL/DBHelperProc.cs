...
namespace DAL
{
    public class DBHelper
    {
        ...
        private static string connStr = "Server=10.1.155.88;DATABASE=Group7;UID=sa;PWD=123";
        ...
        /// <returns></returns>
        public static DataTable GetDataTable(string procName, SqlParameter[] paras = null)//传入存储过程名，数据名
        {
            Open();
